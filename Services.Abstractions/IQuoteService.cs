...
public interface IQuoteService
{
	...
	Task CreateQuoteAsync(QuoteDto quoteDto, CancellationToken cancellationToken = default);
	...
	Task OficializeQuoteAsync(OficializeQuoteDto oficializeQuoteDto, CancellationToken cancellationToken);
}