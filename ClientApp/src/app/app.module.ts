...
} from './components/normalized-vertical-bar-chart/normalized-vertical-bar-chart.component';
...
} from './helpers/stacked-vertical-bar-chart/stacked-vertical-bar-chart.component';
