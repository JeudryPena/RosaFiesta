...
namespace Persistence.Migrations
{
    ...
    [Migration("20240121213044_added province")]
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.WishListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("b22698b8-42a2-4115-9631-1c2d1e2ac5f7"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 44, 2, DateTimeKind.Unspecified).AddTicks(9941), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        },
                        new
                        {
                            Id = new Guid("7d9b7113-a8f8-4035-99a7-a20dd400f6a3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 44, 3, DateTimeKind.Unspecified).AddTicks(40), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "7d9b7113-a8f8-4035-99a7-a20dd400f6a3"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e1"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 44, 3, DateTimeKind.Unspecified).AddTicks(46), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e1"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e2"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 44, 3, DateTimeKind.Unspecified).AddTicks(49), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e2"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 44, 3, DateTimeKind.Unspecified).AddTicks(53), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e3"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Security.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0eb6a908-be2a-42d5-b0d7-836a2295cb10",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 43, 535, DateTimeKind.Unspecified).AddTicks(1908), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELNNhYyIF11fIuel/8KkMdLrZt32q5a+vtHmVcejYvd+B9/MwO41esXbjxekUGs9Mg==",
                            PromotionalMails = false,
                            SecurityStamp = "bf4776dc-9100-4434-9d4c-aa2fa1b9cc09",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "08ecbbe1-38ac-43b5-8d6a-bd4d61069a12",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 43, 535, DateTimeKind.Unspecified).AddTicks(2166), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGvjSrO9cZF2vDCDQ7vXoLbNRdZ/No0pipqRl9PJRiHpMcQRgbzzECHz8IHZlJe2SA==",
                            PromotionalMails = false,
                            SecurityStamp = "07b40527-9dd1-46c0-88a4-bb3ea9be332a",
                            TwoFactorEnabled = false,
                            UserName = "Rosanny"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "b5e8c92f-fdb5-4535-b988-1137b615bb34",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 43, 535, DateTimeKind.Unspecified).AddTicks(2195), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMQvJjLCCEdP42jQU7Lcbp+ASAQgpJxz+hZhh6aI90DI2ZeMZRvLuzN5bHnC3cpEHQ==",
                            PromotionalMails = false,
                            SecurityStamp = "d656b12b-7018-4b28-bc6c-ea806fe473dc",
                            TwoFactorEnabled = false,
                            UserName = "Rosalba2"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "1a813f07-b02e-45b6-8e8e-7fb429e6cdc2",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 43, 535, DateTimeKind.Unspecified).AddTicks(2209), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHhJUrQ6IOcAZ2RRJbRe/8PO/hZq6SDvg6H74IdESyOJxr6DtDOJCjnuBAnOY/wkYA==",
                            PromotionalMails = false,
                            SecurityStamp = "9ab7e426-40aa-484b-aaaf-810d24c3120e",
                            TwoFactorEnabled = false,
                            UserName = "Jendry"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "ef9b44eb-caf6-4037-bd32-452bebcbb132",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 17, 30, 43, 535, DateTimeKind.Unspecified).AddTicks(2261), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHwLXAGoG4PPeeL454hjgeQCWFa+d8PoLAgnz86tEBem42YSONNfXQ8tOU37kUrPGw==",
                            PromotionalMails = false,
                            SecurityStamp = "44f3f327-0622-4210-aad3-18939380a8b2",
                            TwoFactorEnabled = false,
                            UserName = "Rosmery"
                        });
                });
