...
namespace Persistence.Migrations
{
    ...
    [Migration("20240121205427_total")]
    partial class total
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.WishListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("b22698b8-42a2-4115-9631-1c2d1e2ac5f7"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 498, DateTimeKind.Unspecified).AddTicks(7349), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        },
                        new
                        {
                            Id = new Guid("7d9b7113-a8f8-4035-99a7-a20dd400f6a3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 498, DateTimeKind.Unspecified).AddTicks(7441), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "7d9b7113-a8f8-4035-99a7-a20dd400f6a3"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e1"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 498, DateTimeKind.Unspecified).AddTicks(7445), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e1"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e2"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 498, DateTimeKind.Unspecified).AddTicks(7447), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e2"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 498, DateTimeKind.Unspecified).AddTicks(7450), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e3"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Security.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "49beb6a4-d47e-4fcc-8835-5114479d9954",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 105, DateTimeKind.Unspecified).AddTicks(9242), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELM358b2aA5RdlZH7w0HomyabS154FmLUbmO+wEWQIrHRm2GNDSKZ4/8uq12epfVzg==",
                            PromotionalMails = false,
                            SecurityStamp = "1ea924b7-e727-44c7-8ddf-59c8b6af0843",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "faba3bfb-a35d-4af7-a953-812410fe56e8",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 105, DateTimeKind.Unspecified).AddTicks(9479), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAECWrxRBwx0dUSWgZC8gfr9KBvQrHh8QsWo6eA7FbAPJeENICCDVbQZRfNSBVxK2Bmw==",
                            PromotionalMails = false,
                            SecurityStamp = "6ddee03a-fefd-4e4c-bdb4-f2e488acea81",
                            TwoFactorEnabled = false,
                            UserName = "Rosanny"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "c257c014-9599-4f24-91c3-6a06b25c5c74",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 105, DateTimeKind.Unspecified).AddTicks(9511), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDppVEpeFQUyL0FVk+Z1ERjsw/Jzmj8ruBUsuyeC9uiOdgHWEbUzE9nL4aOfcPEXAw==",
                            PromotionalMails = false,
                            SecurityStamp = "4031eccb-ab4c-40e8-b2c1-b7834d85e2d7",
                            TwoFactorEnabled = false,
                            UserName = "Rosalba2"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "80937e67-fff0-437a-ad97-071f59e4147e",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 105, DateTimeKind.Unspecified).AddTicks(9522), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEIWgOgHjBSXvDZJxkf3mov9E0dTZSKvuRnnQ6ffklikIEGaayM7BR6J9SVY0o1wkXQ==",
                            PromotionalMails = false,
                            SecurityStamp = "aec64080-353b-454e-b328-ea91c329268f",
                            TwoFactorEnabled = false,
                            UserName = "Jendry"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "cae0d551-aa03-4928-8e3d-e8fa92ca5d84",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 21, 16, 54, 27, 105, DateTimeKind.Unspecified).AddTicks(9534), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKh4WaZvV5PSGBhaxohXC4NIcaGz0klM49h01PJDu5oBUpHvrTD6OiYUFcn/rQ8lGQ==",
                            PromotionalMails = false,
                            SecurityStamp = "eb395f23-834a-4f76-87ef-50d10d6602a6",
                            TwoFactorEnabled = false,
                            UserName = "Rosmery"
                        });
                });
