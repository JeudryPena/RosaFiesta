...
namespace Persistence.Migrations
{
    ...
    [Migration("20240123170459_FieldsDateAddress")]
    partial class FieldsDateAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.WishListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("b22698b8-42a2-4115-9631-1c2d1e2ac5f7"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 422, DateTimeKind.Unspecified).AddTicks(6905), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        },
                        new
                        {
                            Id = new Guid("7d9b7113-a8f8-4035-99a7-a20dd400f6a3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 422, DateTimeKind.Unspecified).AddTicks(6985), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "7d9b7113-a8f8-4035-99a7-a20dd400f6a3"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e1"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 422, DateTimeKind.Unspecified).AddTicks(6989), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e1"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e2"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 422, DateTimeKind.Unspecified).AddTicks(6992), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e2"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 422, DateTimeKind.Unspecified).AddTicks(6994), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e3"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Security.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9a1f5451-8d7c-4483-bb6a-5783cdb9ab94",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 136, DateTimeKind.Unspecified).AddTicks(7552), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEkM77dEKjadac7xY6pP12dPPe3fINkkQiY+0V+ltwtIzB/5mSPy5pGlKm8uxpEQVw==",
                            PromotionalMails = false,
                            SecurityStamp = "f2eb0b31-46c9-421e-8d18-8fac08616b94",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ba0dabd1-4dae-406c-9755-7b3cb3b3fbe2",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 136, DateTimeKind.Unspecified).AddTicks(7856), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJYuDi0RhrYtKdQCPoABE516bYFqpg2uWxUYx83jnNPgtYTMja+dUPF25WVFi8DDWg==",
                            PromotionalMails = false,
                            SecurityStamp = "5c61eed8-ccca-4933-8c02-69466f2f83e6",
                            TwoFactorEnabled = false,
                            UserName = "Rosanny"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "c40af015-a157-444c-9c7b-68f224f42b90",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 136, DateTimeKind.Unspecified).AddTicks(7871), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBUheOwixPdftLSLMCrsSqaMTpRr4FCn8IK78JPeJ+lhT40b36UqZWZIGq9PiPliug==",
                            PromotionalMails = false,
                            SecurityStamp = "b2326774-8b9e-4fee-b827-ed1b0a7ec0ce",
                            TwoFactorEnabled = false,
                            UserName = "Rosalba2"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "087fd3d5-4d57-4e41-b1e5-3ebf2ec52934",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 136, DateTimeKind.Unspecified).AddTicks(7885), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHxk7zKrQIODllPVCTCIHOetBOHwnaoFm0TrSaZzfIeMrSObkigsmOs8DufEJA4qZw==",
                            PromotionalMails = false,
                            SecurityStamp = "5002da16-71fc-4179-8b4d-b9aacb8fe221",
                            TwoFactorEnabled = false,
                            UserName = "Jendry"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "bebdfbde-0c94-4d81-9e62-9a214a8f3ed3",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 23, 13, 4, 59, 136, DateTimeKind.Unspecified).AddTicks(7933), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEL2JLoT2xZLoyYIt4uSlmKLelycqyXFUQ7+LaiXNevI7EyP+pbcLlHXO4m9QDTSeMA==",
                            PromotionalMails = false,
                            SecurityStamp = "ac71219c-3523-49dd-9472-8af6f381bfde",
                            TwoFactorEnabled = false,
                            UserName = "Rosmery"
                        });
                });
