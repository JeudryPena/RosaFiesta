            ...
            modelBuilder.Entity("Domain.Entities.Product.DiscountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Start = new DateTimeOffset(new DateTime(2023, 5, 8, 23, 47, 28, 768, DateTimeKind.Unspecified).AddTicks(1567), new TimeSpan(0, 0, 0, 0, 0)),
                            Type = 1,
                            Value = 200.0,
                            MaxTimesApply = 5
                        },
                        new
                        {
                            ...
                            Start = new DateTimeOffset(new DateTime(2023, 5, 8, 23, 47, 28, 768, DateTimeKind.Unspecified).AddTicks(1577), new TimeSpan(0, 0, 0, 0, 0)),
                            Type = 0,
                            Value = 10.0,
                            MaxTimesApply = 1
                        });
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.ReviewEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OptionId = 1,
                            Date = new DateTimeOffset(new DateTime(2023, 5, 8, 23, 47, 28, 776, DateTimeKind.Unspecified).AddTicks(7739), new TimeSpan(0, 0, 0, 0, 0)),
                            Description= "Excellent",
                            Rating = 5f,
                            Title = "Nice product",
                            UpdateDate = new DateTimeOffset(new DateTime(2023, 5, 8, 23, 47, 28, 776, DateTimeKind.Unspecified).AddTicks(7741), new TimeSpan(0, 0, 0, 0, 0)),
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        },
                        new
                        {
                            ...
                            OptionId = 1,
                            Date = new DateTimeOffset(new DateTime(2023, 5, 8, 23, 47, 28, 776, DateTimeKind.Unspecified).AddTicks(7747), new TimeSpan(0, 0, 0, 0, 0)),
                            Description= "So so i liked the expierience a bit",
                            Rating = 3f,
                            Title = "Kinda love it",
                            UpdateDate = new DateTimeOffset(new DateTime(2023, 5, 8, 23, 47, 28, 776, DateTimeKind.Unspecified).AddTicks(7748), new TimeSpan(0, 0, 0, 0, 0)),
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        });
                });
