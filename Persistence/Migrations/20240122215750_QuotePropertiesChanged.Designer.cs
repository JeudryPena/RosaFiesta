...
namespace Persistence.Migrations
{
    ...
    [Migration("20240122215750_QuotePropertiesChanged")]
    partial class QuotePropertiesChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.WishListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("b22698b8-42a2-4115-9631-1c2d1e2ac5f7"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 600, DateTimeKind.Unspecified).AddTicks(3664), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        },
                        new
                        {
                            Id = new Guid("7d9b7113-a8f8-4035-99a7-a20dd400f6a3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 600, DateTimeKind.Unspecified).AddTicks(3753), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "7d9b7113-a8f8-4035-99a7-a20dd400f6a3"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e1"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 600, DateTimeKind.Unspecified).AddTicks(3757), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e1"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e2"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 600, DateTimeKind.Unspecified).AddTicks(3760), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e2"
                        },
                        new
                        {
                            Id = new Guid("2301d884-221a-4e7d-b509-0113dcc043e3"),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 600, DateTimeKind.Unspecified).AddTicks(3763), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            UserId = "2301d884-221a-4e7d-b509-0113dcc043e3"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Security.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3a15f0f7-e82a-4526-be6c-96900340bead",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 105, DateTimeKind.Unspecified).AddTicks(1122), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEIyecY5p7GC+hM310dwuHTzks9MQTIVA6vBqPQTE/1gKu1AcI6doiJfF/3+X6pypqg==",
                            PromotionalMails = false,
                            SecurityStamp = "296cb5c2-e81a-4831-8ab9-496173f75f32",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "4b2b69c7-3979-414e-8477-500f7811830c",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 105, DateTimeKind.Unspecified).AddTicks(1380), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEO4Hh+kFZMpAGCRCGOTs7BzjgZ4RrKA5wrVu1/5+XFRcoBjzXtqBW5FP0JosY4dX2A==",
                            PromotionalMails = false,
                            SecurityStamp = "e1eacbed-7601-402b-bf14-d3fe1ea75fa1",
                            TwoFactorEnabled = false,
                            UserName = "Rosanny"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "ab4fe1df-31df-49c3-8584-8c9058829c2d",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 105, DateTimeKind.Unspecified).AddTicks(1411), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEORQYoGEicX4gd46qB3N0CUJQAVfvwuAPtTj9gxRSDU14jm1zIF0PcrPlWgnK1kgSw==",
                            PromotionalMails = false,
                            SecurityStamp = "cf18a55f-36a3-4ca3-8563-c2b3008acd18",
                            TwoFactorEnabled = false,
                            UserName = "Rosalba2"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "9b8ae117-115b-4ea5-ab7e-4ab7489bd5fd",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 105, DateTimeKind.Unspecified).AddTicks(1439), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFzOpNNR56BYdSOywYASHCvVdprH/UaWn9bnFtRtdT/IotRWT9QAKV0HovGp5O6L2A==",
                            PromotionalMails = false,
                            SecurityStamp = "67c14645-6d12-41a6-974e-a8d504e4f2fc",
                            TwoFactorEnabled = false,
                            UserName = "Jendry"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "aaf32f37-462c-4417-b923-b93dd8249454",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 1, 22, 17, 57, 50, 105, DateTimeKind.Unspecified).AddTicks(1494), new TimeSpan(0, -4, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAdbhD6OxZC5KLQqj0OXpDP1xsQiJO3AXx+aHfC+uZ2B2KhYq/mq4LGsSRRKhK4Hfw==",
                            PromotionalMails = false,
                            SecurityStamp = "913edb69-7aea-40c5-af6b-572e692525fe",
                            TwoFactorEnabled = false,
                            UserName = "Rosmery"
                        });
                });
