...
namespace Persistence.Migrations
{
    ...
    [Migration("20230609160842_actionlogremoved")]
    partial class actionlogremoved
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Product.CategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 630, DateTimeKind.Unspecified).AddTicks(8918), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.Entities.Product.DiscountEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = "ROSA",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 632, DateTimeKind.Unspecified).AddTicks(7941), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            Start = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 632, DateTimeKind.Unspecified).AddTicks(7936), new TimeSpan(0, 0, 0, 0, 0)),
                            Type = 1,
                            Value = 200.0
                        },
                        new
                        {
                            Code = "WELCOME",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 632, DateTimeKind.Unspecified).AddTicks(7945), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "100$ de descuento en todos los productos",
                            End = new DateTimeOffset(new DateTime(2023, 9, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            MaxTimesApply = 1,
                            Name = "Descuento de Bienvenida",
                            Start = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 632, DateTimeKind.Unspecified).AddTicks(7943), new TimeSpan(0, 0, 0, 0, 0)),
                            Type = 0,
                            Value = 10.0
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Product.OptionEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Color = "Gold",
                            Condition = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 634, DateTimeKind.Unspecified).AddTicks(4001), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Color = "White",
                            Condition = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 634, DateTimeKind.Unspecified).AddTicks(4006), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Color = "Green",
                            Condition = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 634, DateTimeKind.Unspecified).AddTicks(4010), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Polo XL",
                            GenderFor = 3,
                            IsDeleted = false,
                            Material = 6,
            ...
            modelBuilder.Entity("Domain.Entities.Product.ProductEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Brand = "Champion",
                            CategoryId = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 639, DateTimeKind.Unspecified).AddTicks(182), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            Brand = "Flores",
                            CategoryId = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 639, DateTimeKind.Unspecified).AddTicks(220), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            SupplierId = new Guid("b22698b8-42a2-4115-9631-1c2d1e2ac5f9"),
                            Title = "Flores",
                            Type = 1,
            ...
            modelBuilder.Entity("Domain.Entities.Product.SubCategoryEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 644, DateTimeKind.Unspecified).AddTicks(9358), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.Entities.Product.SupplierEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "La Capital",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 645, DateTimeKind.Unspecified).AddTicks(2431), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.AppliedDiscountEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AppliedDate = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 628, DateTimeKind.Unspecified).AddTicks(8391), new TimeSpan(0, -4, 0, 0, 0)),
                            Code = "ROSA",
                        ...
                        {
                            Id = 2,
                            AppliedDate = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 628, DateTimeKind.Unspecified).AddTicks(8428), new TimeSpan(0, -4, 0, 0, 0)),
                            Code = "WELCOME",
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        },
                        new
                        {
                            Id = 3,
                            AppliedDate = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 628, DateTimeKind.Unspecified).AddTicks(8430), new TimeSpan(0, -4, 0, 0, 0)),
                            Code = "WELCOME",
                            UserId = "b22698b8-42a2-4115-9631-1c2d1e2ac5f7"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.PayMethodEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("b22698b8-42a2-4115-9631-1c2d1e2ac5f4"),
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 636, DateTimeKind.Unspecified).AddTicks(2644), new TimeSpan(0, -4, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.PurchaseDetailEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PurchaseNumber = 1,
                            CartId = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 640, DateTimeKind.Unspecified).AddTicks(7356), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            ProductId = "SDA01"
                        },
                        new
                        {
                            PurchaseNumber = 2,
                            CartId = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 640, DateTimeKind.Unspecified).AddTicks(7370), new TimeSpan(0, -4, 0, 0, 0)),
                            IsDeleted = false,
                            ProductId = "SDA02"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.PurchaseDetailOptions", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OptionId = 1,
                            AppliedId = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 642, DateTimeKind.Unspecified).AddTicks(7494), new TimeSpan(0, -4, 0, 0, 0)),
                            Quantity = 3,
                            UnitPrice = 1200.0
                        },
                        new
                        {
                            ...
                            OptionId = 2,
                            AppliedId = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 642, DateTimeKind.Unspecified).AddTicks(7511), new TimeSpan(0, -4, 0, 0, 0)),
                            Quantity = 4,
                            UnitPrice = 800.0
                        },
                        new
                        {
                            ...
                            OptionId = 3,
                            AppliedId = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 642, DateTimeKind.Unspecified).AddTicks(7514), new TimeSpan(0, -4, 0, 0, 0)),
                            Quantity = 2,
                            UnitPrice = 800.0
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Product.UserInteract.ReviewEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 643, DateTimeKind.Unspecified).AddTicks(8311), new TimeSpan(0, -4, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 12, 8, 41, 643, DateTimeKind.Unspecified).AddTicks(8316), new TimeSpan(0, -4, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.Entities.Product.WarrantyEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 42, 16, DateTimeKind.Unspecified).AddTicks(26), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Domain.Entities.Security.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "8cf417b5-86b4-40fe-ba11-39223cffdecc",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 654, DateTimeKind.Unspecified).AddTicks(8708), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMK2rtkbWzZKDmdG2WQBbS7QUlaapZaCjN3/xT8hCF4wdPxjiE1azizY6iOl8AXq2Q==",
                            PhoneNumber = "18497505944",
                            PhoneNumberConfirmed = true,
                            PromotionalMails = false,
                            SecurityStamp = "d2df41ee-5880-4b16-b221-439bbf32a928",
                        ...
                        new
                        {
                            ...
                            Age = 15,
                            BirthDate = new DateTimeOffset(new DateTime(1996, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -4, 0, 0, 0)),
                            ConcurrencyStamp = "93adf123-0fa3-4a4a-afad-f6cb04e89713",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 654, DateTimeKind.Unspecified).AddTicks(8748), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMOP4JhAbOZYjxklTj08rJrUMuZu6nG987g4iTDuvxFUpc0mcHW7umvMcTxiBZ+nBw==",
                            PhoneNumber = "18497505945",
                            PhoneNumberConfirmed = true,
                            PromotionalMails = false,
                            SecurityStamp = "9ca44b23-527f-471a-85e7-97655d9fe7c5",
                            TwoFactorEnabled = false,
                            UserName = "Rosanny"
                        },
                        new
                        {
                            ...
                            Age = 15,
                            BirthDate = new DateTimeOffset(new DateTime(1996, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -4, 0, 0, 0)),
                            ConcurrencyStamp = "c21f58de-236c-4eb6-a37f-ad8f434ddbf3",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 654, DateTimeKind.Unspecified).AddTicks(8762), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEFd3gEICva58LcGG1XmqCZfHHOcgMNT+EL3BDN0lR27sleg5s2XQ39D4E8FbxaUYVA==",
                            PhoneNumber = "18497505946",
                            PhoneNumberConfirmed = true,
                            PromotionalMails = false,
                            SecurityStamp = "0f1e558c-bdb6-451e-8c9b-d67e5b0ef0b8",
                            TwoFactorEnabled = false,
                            UserName = "Rosalba2"
                        },
                        new
                        {
                            ...
                            Age = 15,
                            BirthDate = new DateTimeOffset(new DateTime(1996, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -4, 0, 0, 0)),
                            ConcurrencyStamp = "47b25bbd-1fba-46ce-87f2-6a19b4bc9f30",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 654, DateTimeKind.Unspecified).AddTicks(8779), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJrpkSJU0Az/KqSI6EgOX/eQPszRA0ormCmNtwYBCPWmKudvAsqCmRRBBIXsEONLIA==",
                            PhoneNumber = "18497505947",
                            PhoneNumberConfirmed = true,
                            PromotionalMails = false,
                            SecurityStamp = "a4370643-36fb-407c-88b2-76223a5dfcf0",
                            TwoFactorEnabled = false,
                            UserName = "jendry"
                        },
                        new
                        {
                            ...
                            Age = 15,
                            BirthDate = new DateTimeOffset(new DateTime(1996, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, -4, 0, 0, 0)),
                            ConcurrencyStamp = "3b5cfa85-3732-4e66-9fb9-cf08bf70d8b0",
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 6, 9, 16, 8, 41, 654, DateTimeKind.Unspecified).AddTicks(8806), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPPsPst8dINnjhuxnI7+d1h7etPjnLxA4II5q+tbq4zWV7diJ3PnEpIRsUXyfaUVKw==",
                            PhoneNumber = "18497505948",
                            PhoneNumberConfirmed = true,
                            PromotionalMails = false,
                            SecurityStamp = "37302607-a97d-4c7f-8aa9-bc33592e639f",
                            TwoFactorEnabled = false,
                            UserName = "Rosmery"
                        });
                });
